...
//initJSetiquetas
if (camposSeleccionados.includes("etiquetas")) r.etiquetas = i?.etiquetas;
//endJSetiquetas
//camposExcel
...
//search
//initJSetiquetas
{ id: "etiquetas", name: "Etiquetas", type: "string" },
//endJSetiquetas//search
//fieldsSearch
...
{/* initJSXetiquetas */}
{camposSeleccionados.includes("etiquetas") && <td>{casos?.etiquetas}</td>}
{/* endJSXetiquetas */}
{/* camposTabla */}
